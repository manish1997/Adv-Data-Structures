//This code involve Segment tree using Lazy Propagation for range update.
//Question Link: http://codeforces.com/contest/52/problem/C
//Did this to implement Lazy Propagation
//Doubt: Why it is needed to update Lazy[node] whenever update(node) is called. Need to clear this. :)
